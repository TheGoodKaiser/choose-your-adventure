...
function* chooseYourAdventure() {
	...
	player.stam = 0; /*increases health at base .25 per point*/
	...
	if (player.myClass=="Knight") {
			...
			var myWeap = yield adventure.choose("Choose your equipment, "+player.myClass+"!", "Staff");
		} else if (player.myClass=="Rogue") {
			var myWeap = yield adventure.choose("Choose your equipment, "+player.myClass+"!", "Dueling Rapier and Dagger", "Assassin's Blades", "Bow and Arrow");
		} else if (player.myClass=="Godmodetest") {
			var myWeap = yield adventure.choose("Choose your equipment, "+player.myClass+"!", "OP");
		}
	// var weapons = {
